...
server {
    listen 80;
    server_name jenkins.evolutionsystems.net;
...
sudo certbot --nginx -d jenkins.evolutionsystems.net --email eric.tadah88@gmail.com --non-interactive --agree-tos --redirect
...
echo "Jenkins is now accessible via https://jenkins.evolutionsystems.net"
